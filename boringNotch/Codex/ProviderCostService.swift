...
enum ProviderCostServiceError: LocalizedError, Equatable {
  ...
  var errorDescription: String? {
    ...
    case .responseTooLarge: "The provider returned more billing data than boring.notch accepts."
...
struct OpenAIAdminCostService: ProviderCostFetching {
  ...
  private func makeRequest(
    ...
    request.setValue("boring.notch/\((Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String ?? "unknown"))", forHTTPHeaderField: "User-Agent")
    return request
  }
