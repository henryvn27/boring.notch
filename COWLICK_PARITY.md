...
| First-run activity consent, Cowlick hook migration, hook install/repair, trust check, and self-test | `CodexHookInstaller.swift`, `CodexHookTrustService.swift`, `IntegrationSelfTestService.swift`, `CodexSettingsView.swift` | Consent-policy, installer, migration, trust, and integration tests |
